...
@click.option(
    "--vocab_size",
    "vocab_size",
    help="Size of the base vocabulary",
    metavar="INT",
...
def main(vocab_size, n_embd, n_layer, max_steps):
    data_path = "./data/hye_wikipedia_2021_1M/cleaned_corpus_for_training.txt"
    base_conf = ConfigDict()
    base_conf.vocab_size = vocab_size
    base_conf.n_embd = n_embd
    base_conf.n_layer = n_layer
    base_conf.max_steps = max_steps
    print(base_conf)
